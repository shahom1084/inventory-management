            ...
            <div className="relative w-full max-w-lg mx-auto bg-white rounded-2xl shadow-xl overflow-hidden my-6 sm:my-0 max-h-[90vh] overflow-y-auto">
                <div className="sticky top-0 bg-slate-800 text-slate-100 px-5 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-md bg-amber-500/90 text-white flex items-center justify-center"><span className="text-xs font-bold">NI</span></div>
                ...
                <form onSubmit={handleSubmit} className="p-5 space-y-4">
                    ...
                    <div className="flex items-center justify-end gap-2 pt-2">
                        ...
                        <button type="submit" disabled={loading} className="px-4 py-2 rounded-md bg-amber-500 hover:bg-amber-600 text-white shadow disabled:opacity-50">{loading ? 'Saving...' : 'Create Item'}</button>
                    </div>
                </form>
            </div>
        </div>
